    ...
    public partial class Reportes : Form
    {
        ...
        public void cargarRegistrosPP()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                dataGridView1.Columns.Clear();
                DataTable table = new DataTable();
                SqlDataAdapter adapter = new SqlDataAdapter("select Id, Nombres, Apellidos, Identificacion from registros", connection);
                adapter.Fill(table);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (e.ColumnIndex == dataGridView1.Columns["MODIFICAR"].Index && e.RowIndex >= 0)
                {
                    ...
                    reportGeneral.Idregistro = id;
                    reportGeneral.connectionString = connectionString;
